...
<html>
  ...
  <head>
    ...
    <title>Springfield Academy - Application for Free and Reduced Price School Meals</title>
      ...
      <section class="form__section form__section-intro" id="form__section-0">
        ...
        <div class="form__section--intro-text">
          ...
          <div class="input__wrapper">
            ...
            <input id="signature" name="signature" type="text" class="required" value="" autofocus>
            ...
            <table>
              ...
              <tr class="child">
                <td>
                  ...
                  <input id="child-first-name-1" name="child-first-name-1" type="text" class="required" value="">
                ...
                <td>
                  ...
                  <input id="child-last-name-1" name="child-last-name-1" type="text" class="required" value="">
                ...
                <td>
                  <fieldset class="usa-fieldset-inputs usa-sans">
                    ...
                    <ul class="usa-unstyled-list">
                      ...
                      <li>
                        <input id="child-status-headstart-1" type="checkbox" name="child-status-headstart-1" value="Head Start">
          ...
          <section class="form__section--sub">
            ...
            <fieldset class="usa-fieldset-inputs usa-sans">          
              ...
              <ul class="usa-unstyled-list">
                ...
                <li>
                  <input id="assistance-n" type="radio" name="assistance" value="No Assistance" class="required required-pair-radio-input">
            ...
            <table id="adult-income">
              ...
              <tr class="adult">
                <td>
                  ...
                  <input id="adult-first-name-1" name="adult-first-name-1" type="text" class="required" value="">
                  <span class="input__error-message" role="alert"><span class="input__error-message--required">First name is required</span></span>
                </td>
                <td>
                  <label for="adult-last-name-1" class="label-hidden-text">Adult Last Name</label>
                  <input id="adult-last-name-1" name="adult-last-name-1" type="text" class="required" value="">
                  <span class="input__error-message" role="alert"><span class="input__error-message--required">Last name is required</span></span>
                </td>
                <td class="adult-each">
          ...
          <section class="form__section--sub">
            ...
            <fieldset class="usa-fieldset-inputs usa-sans">          
              ...
              <ul class="usa-unstyled-list">
                ...
                <li>
                  <input id="ssn-n" type="radio" name="ssn" value="No SSN" class="required">
        ...
        <section class="form__section--body">
          ...
          <section class="form__section--sub">
            ...
            <div class="input__wrapper">
              ...
              <input id="city" name="city" type="text" class="required" value="">
            ...
            <div class="input__wrapper">
              ...
              <input id="zip" name="zip" type="text" class="required" maxlength="5" value="">
              <span class="input__error-message" role="alert"><span class="input__error-message--required">ZIP code is required</span></span>
            </div>
            <div class="input__wrapper">
              <label for="phone">Phone Number</label>
              <input id="phone" name="phone" type="text" class="validate validate-phone" maxlength="12" value="">
            ...
            <div class="input__wrapper">
              ...
              <input id="email" name="email" type="text" class="validate validate-email" value="">
